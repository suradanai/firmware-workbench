...
# --- Utilities (checksum, partition info, entropy, etc.) ---
...
# --- LogEmitter for threading log to GUI ---
class LogEmitter(QObject):
    log_signal = Signal(str)

# --- Auto-detect rootfs offset/size ---
...
# --- AI วิเคราะห์ firmware อัตโนมัติ (ใช้ offset/size ที่กำหนด) ---
...
# --- Detect mksquashfs compression support ---
...
class MainWindow(QMainWindow):
    ...
    def patch_root_password(self):
        ...
        # 4. สร้าง squashfs ใหม่ (รองรับ xz/gzip อัตโนมัติ)
